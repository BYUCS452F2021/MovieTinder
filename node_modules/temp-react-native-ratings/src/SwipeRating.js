...
const STAR_IMAGE = require('temp-react-native-ratings/src/images/star.png');
const HEART_IMAGE = require('temp-react-native-ratings/src/images/heart.png');
const ROCKET_IMAGE = require('temp-react-native-ratings/src/images/rocket.png');
const BELL_IMAGE = require('temp-react-native-ratings/src/images/bell.png');
...
export default class SwipeRating extends Component {
  static defaultProps = {
    type: 'star',
    ratingImage: require('temp-react-native-ratings/src/images/star.png'),
    ratingColor: '#f1c40f',
  ...
  async componentDidMount() {
    try {
      const STAR_IMAGE = await require('temp-react-native-ratings/src/images/star.png');
      const HEART_IMAGE = await require('temp-react-native-ratings/src/images/heart.png');
      const ROCKET_IMAGE = await require('temp-react-native-ratings/src/images/rocket.png');
      const BELL_IMAGE = await require('temp-react-native-ratings/src/images/bell.png');
